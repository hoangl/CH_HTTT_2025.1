...
# Làm phẳng hình ảnh thành vector 24*24 = 576 chiều
...
# Tạo nhãn (1 cho khuôn mặt, -1 cho không phải khuôn mặt)
y_pos = np.ones(X_pos_normalized.shape[0])
y_neg = -np.ones(X_neg_normalized.shape[0])
...
for C in C_values:
    ...
    svm_model = SVC(kernel='linear', C=C, random_state=42, max_iter=10000)
